...
class TRPO:
    def __init__(self, env_name='CartPole-v1', hidden_dim=128, max_d_kl=0.01, window_size=100, gradient_threshold=0.005):
    ...
    def calculate_advantages(self, rewards, values, next_value, dones=None):
    ...
    def save_policy(self, path='trpo_cartpole.pth'):
        torch.save(self.actor_critic.state_dict(), path)

    def load_policy(self, path='trpo_cartpole.pth'):
